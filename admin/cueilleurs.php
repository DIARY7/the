...
<div class="container-fluid py-5">
        ...
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-5">Cueilleurs</h1>
        </div>
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="bg-light rounded p-4 p-sm-5 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="row g-3">
                            <form class="forms-sample" method="post" action="#" id="formCueilleur">
                                <input type="hidden" id="idCueilleur" name="idCueilleur" value="null"/>
                                <div class="col-sm-12">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nomCueilleur" class="form-control" id="nomCueilleur"
                                            placeholder="name">
                                        <label for="nomCueilleur"> Nom : </label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
    ...
    <script src="../asset/js/cueilleur.js"></script>
    </body>
