            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item rounded d-flex h-100">
                    ...
                    <div class="service-text rounded p-5">
                        ...
                        <h4 class="mb-3">Poids restant sur les parcelles</h4>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item rounded d-flex h-100">
                    ...
                    <div class="service-text rounded p-5">
                        ...
                        <h4 class="mb-3">Montant des ventes</h4>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item rounded d-flex h-100">
                    ...
                    <div class="service-text rounded p-5">
                        ...
                        <h4 class="mb-3">Montant des dépenses :</h4>
                        <p class="mb-4" id="totalCueillette" >0</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item rounded d-flex h-100">
                    ...
                    <div class="service-text rounded p-5">
                        ...
                        <h4 class="mb-3">Coût de revient par kg</h4>
                        <p class="mb-4" id="cout_revient" >0</p>
                    </div>
                </div>
            </div>
